...
type JavaScriptCucumberSubstitution struct{}

func (s JavaScriptCucumberSubstitution) Example() string {
	return "npx cucumber-js {{ scenarios }}"
}

func (s JavaScriptCucumberSubstitution) ValidateTemplate(compiledTemplate templating.CompiledTemplate) error {
...
func (s JavaScriptCucumberSubstitution) SubstitutionsFor(
