...
func init() {
	image.InitPush(requireAccessToken, func() cli.Service { return service }, func() string { return Output })
	image.InitBuild(requireAccessToken, ParseInitParameters, func() cli.Service { return service }, RejectJSONOutput)
	image.InitPull(requireAccessToken, func() cli.Service { return service }, RejectJSONOutput)
